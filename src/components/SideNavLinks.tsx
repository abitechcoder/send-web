...
export const links: Link[] = [
  ...
  },
  {
    ...
    text: "Project",
    icon: (
      <ProjectIcon className="group-hover:stroke-primary" />
    ),
    url: "/dashboard",
  },
  {
    ...
    text: "Tasks",
    icon: (
      <TasksIcon className="group-hover:stroke-primary" />
    ),
    url: "/dashboard",
  },
  {
    ...
    text: "Setting",
    icon: (
      <SettingsIcon className="group-hover:stroke-primary" />
    ),
    url: "/dashboard",
  },
  {
    ...
    <ul>
      {links?.map((link) => (
        <RouterLink
          key={link?.id}
          to={link?.url}
          className="flex items-center gap-4 py-4 px-8 group"
        >
          {link?.icon}
          {/* <IconWrapper children={<h1>Hello</h1>}/> */}
          {/* <ProjectIcon className="group-hover:fill-primary group-hover:stroke-primary" /> */}
          <p className="group-hover:text-primary group-hover:font-semibold text-lg font-nunito">
            {link?.text}
          </p>
        </RouterLink>
      ))}
