  ...
  return (
    <div className="flex items-center gap-3 my-1  ">
      ...
      <div className="flex flex-1 items-center gap-10 md:justify-between ">
        <div>
        <h6 className="font-nunito font-normal text-[12px] leading-normal">
          Donation from xxx
        </h6>
        <p className="font-nunito font-normal text-[11px] text-[#718EBF]">28 Jan 2021</p>
        </div>
        <div>
          <p className="font-nunito font-normal text-[12px] leading-normal text-[#41D4A8] right-4 ">
            +$2,500
          </p>
        </div>
