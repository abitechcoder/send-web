  ...
  return (
    <div className={`h-[450px] w-full relative`}>
      <img
        ...
        alt=""
      />
      <div className="grid grid-cols-[1fr_45px] place-content-center px-4 absolute -bottom-[40px] left-[5%] w-[90%] h-[120px] z-10 bg-white">
        <div>
          <h3 className={`${styles.paragraph3} text-secondary`}>{title}</h3>
          <h2 className={`${styles.paragraph} text-black font-bold`}>{name}</h2>
        </div>
        <div className="bg-secondary w-[40px] h-[40px] grid place-items-center">
          <svg
            width="28"
            height="18"
            viewBox="0 0 28 18"
