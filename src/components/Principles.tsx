      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="h-[420px] md:h-[510px] relative">
          ...
          <img
            ...
            className="absolute top-0 left-[50px] w-[85%] lg:w-[70%] h-[350px] lg:h-[420px]"
          />
          <img
            src={corporate_identity_image2}
            className="absolute bottom-[30px] md:bottom-[100px] lg:bottom-[50px] right-0 lg:right-[70px] w-[150px] lg:w-[200px] h-[150px] lg:h-[250px] z-10"
          />
