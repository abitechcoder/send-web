...
import { HappyChildren1, HappyChildren2, IdentityRect1, IdentityRect2 } from "../assets";
    ...
    <section className={`bg-white ${layout.section}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[50px]">
        <div className="h-[450px] w-full md:h-[500px] relative">
          <img
            src={HappyChildren1}
            className="h-[400px] md:h-[450px] lg:h-[90%] bg-cover bg-center w-[80%] md:w-[60%] lg:w-[76%] absolute top-0 left-[10%] md:left-[20%] lg:left-[12%] z-10"
            alt=""
          />
          <img
            src={HappyChildren2}
            className="h-[200px] w-[150px] md:h-[250px] md:w-[200px] bg-cover bg-center absolute bottom-0 lg:right-0 md:right-[10%] right-0 z-20"
            alt=""
          />
          <div className="w-[150px] h-[184px] absolute left-0 md:left-[11%] lg:left-0 bottom-[100px]">
            <p className="text-white absolute z-30 w-[60%] top-[35px] left-[30%]">
              <span className="font-manrope font-bold text-5xl">30</span><br />
              Years of Experience
            </p>
          <img
            src={IdentityRect1}
